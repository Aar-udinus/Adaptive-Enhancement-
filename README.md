...
RAW
Original cropped plate image without additional enhancement.

CLAHE-light
Contrast Limited Adaptive Histogram Equalization with conservative parameters to improve local contrast without distorting character shapes.

SR2× + CLAHE-light
Lightweight 2× upscaling (bicubic interpolation) followed by CLAHE-light, designed for small or low-resolution plates.
...
@article{AdaptiveALPR2025,
  title={Adaptive Enhancement and Plate-Aware OCR Selection for Robust License Plate Recognition in Hazy Conditions},
  author={Author Name},
